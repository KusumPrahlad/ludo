...
import { c as createComponent, d as createAstro, m as maybeRenderHead, e as addAttribute, a as renderScript, b as renderTemplate, r as renderComponent } from '../chunks/astro/server_Cqmuhjlt.mjs';
import { c as cn, $ as $$Layout } from '../chunks/utils_CXtFv3Vu.mjs';
import { $ as $$Image, r as redHorse, b as blueHorse, y as yellowHorse, g as greenHorse } from '../chunks/green_DrH1vFGP.mjs';
...
const $$PlayerCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`player-${id}-area`, "id")}${addAttribute(`flex ${reverse ? "flex-row-reverse" : ""}`, "class")}> <div class="w-15 h-15 rounded-md bg-white"> <figure> <img${addAttribute(`player-${id}-image`, "id")} class="size-full rounded-md aspect-square"${addAttribute(playerName, "alt")}> <figcaption${addAttribute(`player-${id}-name`, "id")} class="text-xs text-center mt-1">${playerName}</figcaption> </figure> </div> <div${addAttribute(`w-12 h-12 ${reverse ? "rounded-l-md" : "rounded-r-md"} mt-1.5 bg-gray-800`, "class")}> <img${addAttribute(`player-${id}-dice`, "id")} class="w-full p-1 player-dice"> </div> <img${addAttribute(`player-${id}-dice-arrow`, "id")}${addAttribute(`h-12 mt-1 ${reverse ? "" : "rotate-180"}`, "class")}> </div> ${renderScript($$result, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/player-card.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/player-card.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/board-blue-middle-path.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/board-green-middle-path.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/board-red-middle-path.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/board-yellow-middle-path.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/ludo-home.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/player-home.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/ludo-board.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-audio.astro", void 0);
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-board/winners-model.astro", void 0);
