...
import { c as createComponent, d as createAstro, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, b as renderTemplate, r as renderComponent, a as renderScript } from '../chunks/astro/server_Cqmuhjlt.mjs';
...
}, "/Users/kusum/Documents/projects/ludon-main/src/components/game-button.astro", void 0);

const $$ShareButton = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Button", $$GameButton, { "id": "share-btn", "class": "w-fit !h-10 mx-auto block", "text": "Share Now!", "color": "#db5c4c" })} ${renderScript($$result, "/Users/kusum/Documents/projects/ludon-main/src/components/share-button.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/kusum/Documents/projects/ludon-main/src/components/share-button.astro", void 0);
...
Created by
<a class="underline font-medium" href="https://x.com/yourcodebuddy">Yourcodebuddy</a> </p> </div> </main> ` })} ${renderScript($$result, "/Users/kusum/Documents/projects/ludon-main/src/pages/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/kusum/Documents/projects/ludon-main/src/pages/index.astro", void 0);

const $$file = "/Users/kusum/Documents/projects/ludon-main/src/pages/index.astro";
const $$url = "";
